...
share_config = {'mode': 'training',
                ...
                'img_size': (256, 256),
                'data_root': 'Data/',
                'save_result': 'results/'}  # remember the final '/'
...
def update_config(args=None, mode=None):
    ...
    # assert args.dataset in ('ped2', 'avenue', 'shanghaitech', 'wood_ano'), 'Dataset error.'
    ...
    if mode == 'train':
        ...
        share_config['dataset'] = args.dataset
        share_config['test_data'] = share_config['data_root'] + args.dataset + '/testing/'
        share_config['ground_truth'] = share_config['data_root'] + args.dataset + '/testing_gt/'
        share_config['background_save_path'] = share_config['save_result'] + args.dataset + '/gen_background/'
        share_config['background_noise_save_path'] = share_config['save_result'] + args.dataset + '/background_noise/'
        share_config['anomaly_save_path'] = share_config['save_result'] + args.dataset + '/anomaly/'
        share_config['trained_model'] = args.trained_model
        share_config['scenario'] = args.scenario
        # share_config['show_curve'] = args.show_curve
        share_config['show_anomaly'] = args.show_anomaly
